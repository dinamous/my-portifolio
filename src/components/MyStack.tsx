...
export default function MyStack() {
  ...
  return (
    <div className="relative py-16 z-auto dark:bg-slate-900 bg-gray-50" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="500" data-aos-duration="500">
